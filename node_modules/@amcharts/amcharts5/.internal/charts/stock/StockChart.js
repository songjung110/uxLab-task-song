    ...
    Object.defineProperty(StockChart.prototype, "_updateChildren", {
        ...
        value: function () {
            ...
            if (this.isDirty("volumeSeries")) {
                ...
                if (volumeSeries_1) {
                    var volumePanel = volumeSeries_1.chart;
                    if (volumePanel) {
                        volumePanel.series.events.on("removeIndex", function (event) {
                            if (event.oldValue == volumeSeries_1) {
                                _this.set("volumeSeries", undefined);
                            }
                        });
                    }
                }
