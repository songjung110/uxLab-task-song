...
var MapPointSeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(MapPointSeries.prototype, "_makeBullets", {
        ...
        value: function (dataItem) {
            ...
            this.bullets.each(function (bulletFunction) {
                ...
                if (geometry) {
                    if (geometry.type == "Point") {
                        _this._setBulletParent(_this._makeBullet(dataItem, bulletFunction));
                    }
                    else if (geometry.type = "MultiPoint") {
                        var i_1 = 0;
                        $array.each(geometry.coordinates, function () {
                            _this._setBulletParent(_this._makeBullet(dataItem, bulletFunction, i_1));
                            i_1++;
                        });
                    }
                }
    ...
    Object.defineProperty(MapPointSeries.prototype, "_setBulletParent", {
        enumerable: false,
        configurable: true,
        writable: true,
        ...
        value: function (bullet) {
            ...
            if (sprite) {
                ...
                if (polygon_1) {
                    ...
                    dataItem_1.setRaw("longitude", geoPoint.longitude);
                    dataItem_1.setRaw("latitude", geoPoint.latitude);
                }
     ...
     * @ignore
     */
    Object.defineProperty(MapPointSeries.prototype, "disposeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
                ...
                chart.series.each(function (series) {
                    if (series.isType("MapLineSeries")) {
                        $array.each(series.dataItems, function (di) {
                            var pointsToConnect = di.get("pointsToConnect");
                            if (pointsToConnect) {
     ...
     * @ignore
     */
    Object.defineProperty(MapPointSeries.prototype, "_excludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
            _super.prototype._excludeDataItem.call(this, dataItem);
     ...
     * @ignore
     */
    Object.defineProperty(MapPointSeries.prototype, "_unexcludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
            _super.prototype._unexcludeDataItem.call(this, dataItem);
            var bullets = dataItem.bullets;
            if (bullets) {
                $array.each(bullets, function (bullet) {
                    var sprite = bullet.get("sprite");
     ...
     * @ignore
     */
    Object.defineProperty(MapPointSeries.prototype, "_notIncludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
            _super.prototype._notIncludeDataItem.call(this, dataItem);
            var bullets = dataItem.bullets;
            if (bullets) {
                $array.each(bullets, function (bullet) {
                    var sprite = bullet.get("sprite");
     ...
     * @ignore
     */
    Object.defineProperty(MapPointSeries.prototype, "_unNotIncludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
            _super.prototype._unNotIncludeDataItem.call(this, dataItem);
            var bullets = dataItem.bullets;
            if (bullets) {
                $array.each(bullets, function (bullet) {
                    var sprite = bullet.get("sprite");
