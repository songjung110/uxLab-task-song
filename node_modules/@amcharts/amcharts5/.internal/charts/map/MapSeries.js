...
var MapSeries = /** @class */ (function (_super) {
    ...
    function MapSeries() {
        ...
        Object.defineProperty(_this, "_excluded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(_this, "_notIncluded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        value: function () {
            ...
            if (this._valuesDirty || this.isDirty("geoJSON") || this.isDirty("include") || this.isDirty("exclude")) {
                ...
                if (exclude) {
                    ...
                    $array.each(exclude, function (id) {
                        var dataItem = _this.getDataItemById(id);
                        if (dataItem) {
                            _this._excludeDataItem(dataItem);
                        }
                    });
                }
                if (!exclude || exclude.length == 0) {
                    $array.each(this._excluded, function (dataItem) {
                        _this._unexcludeDataItem(dataItem);
                    });
                    this._excluded = [];
                }
                var include_1 = this.get("include");
                if (include_1) {
                    if (chart) {
                        chart._centerLocation = null;
                    }
                    $array.each(this.dataItems, function (dataItem) {
                        ...
                        if (id && include_1.indexOf(id) == -1) {
                            _this._notIncludeDataItem(dataItem);
                        }
                        else {
                            _this._unNotIncludeDataItem(dataItem);
                        }
                    });
                }
                if (!include_1) {
                    $array.each(this._notIncluded, function (dataItem) {
                        _this._unNotIncludeDataItem(dataItem);
                    });
                    this._notIncluded = [];
                }
    ...
    Object.defineProperty(MapSeries.prototype, "_excludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
    ...
    Object.defineProperty(MapSeries.prototype, "_unexcludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
    ...
    Object.defineProperty(MapSeries.prototype, "_notIncludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
    ...
    Object.defineProperty(MapSeries.prototype, "_unNotIncludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
    ...
    Object.defineProperty(MapSeries.prototype, "_onDataClear", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
