...
var MapLineSeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(MapLineSeries.prototype, "_afterNew", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
    ...
    Object.defineProperty(MapLineSeries.prototype, "processDataItem", {
        ...
        value: function (dataItem) {
            ...
            dataItem.on("pointsToConnect", function () {
                _this._handlePointsToConnect(dataItem);
            });
            dataItem.set("mapLine", mapLine);
            mapLine.setPrivate("series", this);
        }
    });
    Object.defineProperty(MapLineSeries.prototype, "_handlePointsToConnect", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
     ...
     * @ignore
     */
    Object.defineProperty(MapLineSeries.prototype, "_excludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
     ...
     * @ignore
     */
    Object.defineProperty(MapLineSeries.prototype, "_unexcludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
     ...
     * @ignore
     */
    Object.defineProperty(MapLineSeries.prototype, "_notIncludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
     ...
     * @ignore
     */
    Object.defineProperty(MapLineSeries.prototype, "_unNotIncludeDataItem", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function (dataItem) {
